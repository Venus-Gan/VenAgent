...
def test_agent_react_uses_graph_runtime_path():
    ...
    original_stream = getattr(agent.llm, "chat_stream_context", None)
    agent.llm.chat_stream_context = lambda token, system_prompt, messages, on_token=None: agent.llm.chat(messages, system_prompt=system_prompt)
    ...
    if original_stream is not None:
        agent.llm.chat_stream_context = original_stream
