...
def test_alignment_config_reads_search_provider_settings(tmp_path):
    config_path = tmp_path / "config.yaml"
    config_path.write_text(
        """
search:
...
""",
    ...
    assert cfg.search_api_key == "tavily-key"
    assert cfg.search_api_url == "https://api.tavily.com/search"
